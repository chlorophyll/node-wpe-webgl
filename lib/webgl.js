...
/* Extra (GLES3, but not everything) */
WebGLRenderingContext.prototype.RGBA32F = 0x8814;
WebGLRenderingContext.prototype.RGB32F = 0x8815;
WebGLRenderingContext.prototype.RGBA16F = 0x881A;
WebGLRenderingContext.prototype.RGB16F = 0x881B;
...
WebGLRenderingContext.prototype.texImage2D = function texImage2D(target, level, internalformat, width, height, border, format, type, pixels) {
    ...
    if(!(typeof target === "number" &&
        ...
        (pixels === null || Buffer.isBuffer(pixels) || pixels instanceof Uint8Array || pixels instanceof Float32Array))) {
        throw new TypeError('Expected texImage2D(number target, number level, number internalformat, number width, number height, number border, number format, number type, Buffer pixels)');
    }
